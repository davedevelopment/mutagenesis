...
require_once 'Mutagenesis/Mutation/LogicalIf.php';

class Mutagenesis_Mutation_LogicalIfTest extends PHPUnit_Framework_TestCase
{
     ...
     */
    public function testReturnsTokenEquivalentToWrappedConditional($code, $index, $expected, $desc)
    {
        $mutation = new \Mutagenesis\Mutation\LogicalIf;
